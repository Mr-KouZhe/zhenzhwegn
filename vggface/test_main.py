...
#加载caffe模型
global net
net=caffe.Classifier('/home/two/caffe/models/vgg_face_caffe/VGG_FACE_deploy.prototxt',
    '/home/two/caffe/models/vgg_face_caffe/VGG_FACE.caffemodel')
