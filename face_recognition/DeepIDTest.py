...
#-*- coding:utf-8 -*-
'''
Create on Tues 2015-07-24

@author: FoorestPi
'''

#运行前,先将pycaffe安装好
#运行时在caffe主目录（一般为～/caffe）下执行python DeepIDTest.py
...
def demo_test(num,itera):
    ...
    caffepath=home+'/caffer/'
    prjpath=home+'/caffe/examples/deepID/'
    datapath=home+'/caffe/data/deepID/webface/' 
    types=1
    pairs=home+'/caffe/examples/deepID/pairs.txt'
    lfwpath=home+/caffe/face_recognition-master/lfwcrop_color#lfwpath=home+'/caffe/data/deepID/lfwcrop_color/faces/'
