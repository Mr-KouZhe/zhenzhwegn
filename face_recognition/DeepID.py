...
#-*- coding:utf-8 -*-
'''
Create on Tues 2016-7-24

@author: ForrestPi
'''

#运行前,先将caffe安装好,放在～/caffe
import os
...
#            os.makedirs(savepath)
    ...
    def test(self,iternum):
        ...
        os.system(_command)
def demo(num):
    deepID=DeepID('deepID','/home/two/caffe/','/home/two/caffe/examples/deepID/','/media/two/Document/big_materials/document/deep_learning/caffe/face_datasets/webface/croped/',num)
    ratio=9
