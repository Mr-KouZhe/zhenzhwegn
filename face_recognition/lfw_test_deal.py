...
def demo_webface_resize():
    DEEPID='/home/two/caffe/data/deepID/'
    pairs=DEEPID+'pairs.txt'
#    lfwdir=DEEPID+'lfwcrop_color/faces/'
    lfwdir='/media/two/Document/big_materials/document/deep_learning/caffe/face_datasets/webface/croped/'
    ext='jpg'
    lfw_chang='/media/two/Document/big_materials/document/deep_learning/caffe/face_datasets/webface/change/'
...
def demo_color_resize():
    DEEPID='/home/two/caffe-master/data/deepID/'
    pairs=DEEPID+'pairs.txt'
#    lfwdir=DEEPID+'lfwcrop_color/faces/'
    lfwdir='/media/two/Document/big_materials/document/deep_learning/caffe/face_datasets/webface/croped/'
    ext='jpg'
